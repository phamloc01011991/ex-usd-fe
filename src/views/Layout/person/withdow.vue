...
async function withDawAmount() {
  ...
  var res = await request.post('user/withdrawal_trans', {
    amount: amount.value,
    address: display.value == 2 ? address.value + ' ('+networkSelect.value +')' : null
  })
    ...
    <div class="popbuy-content">
      <div class="top">
       ...
       <div class="pre" v-if="display == 1">
        <h3>{{ languagePack.person_withdow_all }}</h3>
        <div class="otp" @click="display = 2">
      ...
      <div class="popbuy-center otp1" v-if="display == 2">
        <div class="center-time">
          <div class="center-time__body">
            <div class="securityCode" style="margin-bottom: 18px;">
              <div class="t">
                <label for="" style="font-size: 13px; font-weight: 600; margin-bottom: 3px; display: block;">{{ languagePack.person_withdow_bank }}</label>
                <select @change="changeNetwork" v-model="networkSelect" style="text-transform: capitalize;">
              ...
              <div class="form-input">
                <div class="form-control">
                  <input type="text" placeholder="Nhập địa chỉ" v-model="address"/> 
                </div>
              </div>
            </div>
            <div class="valueMoney">
              ...
              <p class="note">
                ...
                {{ formatUsdt((amount - (amount / 100) * feeWithdrawal)) }} USDT.
                </div>
                <div class="fee">
